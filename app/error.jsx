      ...
      <div className="container m-auto max-w-2xl py-24">
        <div className="bg-white px-6 py-24 mb-4 shadow-md rounded-md border m-4 md:m-0">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500 text-xl my-5">Shall we try again? ...</p>
            <button onClick={() => reset()} className="bg-yellow-500 hover:bg-yellow-600 font-bold py-4 px-6 rounded">
              Try again
            </button>
            <p className="text-gray-500 text-xl my-5">Or back to home...</p>
            <Link href="/" className="bg-blue-700 hover:bg-blue-800 text-white font-bold py-4 px-6 rounded inline-block">
              Go Home
            </Link>
          </div>
        </div>
