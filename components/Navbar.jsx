      ...
      {isMobileMenuOpen && (
        <div id="mobile-menu">
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link href="/" className={`${pathname === "/" ? "bg-gray-900" : ""} text-white block rounded-md px-3 py-2 text-base font-medium}`}>
              Home
            </Link>
            <Link href="/properties" className={`${pathname === "/properties" ? "bg-gray-900" : ""} text-white block rounded-md px-3 py-2 text-base font-medium}`}>
              Properties
            </Link>
            {session && (
              <Link href="/properties/add" className={`${pathname === "/properties/add" ? "bg-gray-900" : ""} text-white block rounded-md px-3 py-2 text-base font-medium}`}>
                Add Property
              </Link>
            )}
            {!session &&
